...
const COMPONENT_STATE_MACHINES = {
...
function getComponentStateMachine(componentId) {
  return COMPONENT_STATE_MACHINES[componentId];
}
function getComponentFocusRing(componentId, isDanger = false) {
  const c = COMPONENT_FOCUS_RINGS[componentId];
  if (!c) return "";
  return isDanger ? c.focusRingDanger : c.focusRing;
}
function registerComponentBehaviors() {
}
export {
