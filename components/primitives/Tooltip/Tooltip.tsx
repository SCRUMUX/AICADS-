...
// ─── Appearance styles ─────────────────────────────────────────────────────────
// base uses inverted colors: dark bubble on light bg, light bubble on dark bg.
// This is the standard tooltip pattern — tooltips are always visually "opposite"
// to the background they appear on.
// --color-tooltip-bg / --color-tooltip-text are defined in tokens.css:
//   light: bg=#353535 (dark gray), text=#FFFFFF
//   dark:  bg=#E6EEF8 (light),     text=#1A2330
//
// Semantic variants keep their own brand colors (success/warning/danger).
